...
@SpringBootTest
public class MockedServiceIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(MockedServiceIntegrationTest.class);
	...
	public void getInputTest() {
		...
		assertEquals(false, coordinateController.getLineInput().getBody().toString().contains("lineNumber"));
	}

	@Test
	public void saveToCsvTest() {
		logger.info("saveToCsvTest method");
		ArrayList<Coordinate> cordinateList = new ArrayList<Coordinate>();
		cordinateList.add(new Coordinate(0, 10.0f, 5.0f, 13.0f, 9.0f));
		cordinateList.add(new Coordinate(1, 12.0f, 5.0f, 13.0f, 7.0f));
		...
		assertEquals(HttpStatus.BAD_REQUEST, coordinateController.addLineInput(hm));
	}
